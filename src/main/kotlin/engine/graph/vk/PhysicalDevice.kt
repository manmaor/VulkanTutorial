...
class PhysicalDevice(
    ...
    private val vkMemoryProperties: VkPhysicalDeviceMemoryProperties // contains information related to the different memory heaps the this device supports
    private val vkPhysicalDeviceFeatures: VkPhysicalDeviceFeatures // contains fine-grained features supported by this device, such as if it supports depth clamping, certain types of shaders, etc
